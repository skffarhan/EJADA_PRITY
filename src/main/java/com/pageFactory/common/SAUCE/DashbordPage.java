...
public class DashbordPage {
	...
	public void verifyProducts() {
		...
		if (appProductName1.equals(ProductName)) {
			...
			objPojo.getObjUtilities().logReporter("Values are It's Matching", appProductName1, ProductName, true);
		} else {
			System.out.println("It's a MisMatch!!!");
			objPojo.getObjUtilities().logReporter("Values are not It's Matching", appProductName1, ProductName, false);
		}
		...
		if (appProductName1.equals(ProductName)) {
			System.out.println("It's Matching!!!");
			objPojo.getObjUtilities().logReporter("Values are It's Matching", appProductName2, ProductName, true);
		} else {
			System.out.println("MisMatch!!!");
			objPojo.getObjUtilities().logReporter("Values are It's Matching", appProductName1, ProductName, false);
		}
	}
	...
	public void verifyFinalDetails(String titleName) {
		...
		if (titleName.equals(appTitle)) {
			System.out.println("It's Matching!!!");
			objPojo.getObjUtilities().logReporter("Values for Title page It's Matching", titleName, appTitle, true);
		} else {
			System.out.println("MisMatch!!!");
			objPojo.getObjUtilities().logReporter("Values for Title page It's Matching", titleName, appTitle, false);
		}
